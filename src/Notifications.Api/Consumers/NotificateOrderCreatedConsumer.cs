...
{
    public class NotificateOrderCreatedConsumer : BackgroundService
    {
        private readonly IConnection connection;
        private readonly IModel channel;

        private readonly string queueNameConsumer;
        public NotificateOrderCreatedConsumer(IServiceProvider serviceProvider, IConfiguration configuration)
        {
        ...
        {
            Console.WriteLine("Notificate order created processed");
        }
